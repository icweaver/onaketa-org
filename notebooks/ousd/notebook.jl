...
# ╔═╡ 94577dce-fd4c-11ef-2a61-bb4e508c914a
using DataFramesMeta, AlgebraOfGraphics, CairoMakie, CSV

# ╔═╡ e4982cec-f8a4-4e77-b18f-32c96f18cfe4
df = CSV.read("./data/housing_2023-24.csv", DataFrame; normalizenames=true)

# ╔═╡ 146be2a8-0378-419b-8e4f-9aab1480eea4
df_summary = @chain df begin
	@by :school :"Total number of students" = sum(:n_response)
	@orderby -:"Total number of students"
end;

# ╔═╡ 307888ec-7307-4738-9eb9-3f0ffbdb6c44
PrettyTables.pretty_table(HTML, df_summary)
...
manifest_format = "2.0"
project_hash = "10aa988ca5c94703cbcb9ea34fc06a77c2727be0"
