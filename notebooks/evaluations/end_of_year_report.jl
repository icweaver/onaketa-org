...
begin
	using PlutoUI
	using Typstry, CSV, DataFramesMeta, Printf, Dates, PDFmerger
end
...
let
open("src/end_of_year_report.typ", "w") do report
...
run(typst`compile src/end_of_year_report.typ`)
end;
...
manifest_format = "2.0"
project_hash = "18060ca2d2576e212294bd6f3c9bb15a5aea1d1d"
