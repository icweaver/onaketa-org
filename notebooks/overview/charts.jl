...
df = let
	df0 = CSV.read("./data/student_applications.csv", DataFrame)
	@rsubset! df0 (:student_city in ("Oakland", ) || :school_city in ("Oakland", ))
end;

# ╔═╡ 2b653192-8ad8-432f-a897-7ebc98b4f6d6
df.student_city |> unique |> sort

# ╔═╡ e9477102-379b-4f70-8578-bb3b2b8d5cb6
df_accepted = @chain df begin
	@rsubset :internal_status == "accept"
	sort(:"Submitted at")
end
...
# ╔═╡ 19f56da4-0e1e-4c41-81b0-db3f6b373b0e
let
	df = (; x = map(df_accepted.term_active) do terms
		split(terms, ", ")
	end |> Iterators.flatten |> collect
	)
	
	p = data(df) * mapping(:x => presorted => "") * frequency()
...
Total number of applications supported: $(nrow(df_accepted))
"""
...
manifest_format = "2.0"
project_hash = "a687696f04b23ccfc23bf36921235fa2756b5472"
