...
# let
# 	p = data(df_accepted) * mapping(:term_active => yearhalf => "") *
# 		frequency()
...
# ╔═╡ 5b888898-390e-4e2c-8c32-b372803ae7b4
yuh = map(df_accepted.term_active) do terms
	split(terms, ", ")
...
# ╔═╡ 53dbdf0e-e4d4-4a2c-846c-ca1effdf9797
# let
# 	p = pregrouped(yuh) #* frequency()
